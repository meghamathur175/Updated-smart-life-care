...
function Request() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      // console.log("RES IN REQUESTS.js: ", res);
      
      const freshRequests = res.data.requests || [];
      // console.log("freshRequests IN REQUESTS.js: ", freshRequests);

      setPartnerName(res.data.partner.hospitalName || "Partner");
