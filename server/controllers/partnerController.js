...
const HospitalRegister = require("../models/hospitalregisterModel")
...
exports.getPartnerRequests = async (req, res) => {
  try {
    ...
    const partner = await HospitalRegister.findById(partnerId);
    ...
    res.status(200).json({requests, partner});
