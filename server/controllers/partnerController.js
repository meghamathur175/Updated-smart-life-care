...
exports.confirmRequestToPartner = async (req, res) => {
  try {
    ...
    try {
      ...
      const pickupCoordinates = await getCoordinatesFromAddress(pickup); // [lng, lat]
      ...
      console.log("Nearby drivers found:", nearbyDrivers.map(d => ({
        id: d._id,
      ...
      nearbyDrivers.forEach(driver => {
        console.log("Found nearby driver:", driver._id);
        const socketId = global.driverSockets.get(driver._id.toString());
        if (socketId) {
          console.log("Emitting to driver:", driver._id, "Socket:", socketId);
...
exports.rejectAndTransferRequest = async (req, res) => {
  try {
    ...
    console.log("🚀 Reassigned To:", {
      ...
      status: reassignedRequest.status,
    });
...
exports.updateRequestStatus = async (req, res) => {
  try {
    ...
    console.log("updateRequestStatus -> req.body: ", req.body);
    ...
    console.log("Update request status to: ", request);
...
exports.storeResponseTime = async (req, res) => {
  try {
    ...
    console.log("📥 Response time received:", { partnerId, bookingId, responseTime, action });
