...
const ambulanceRequestSchema = new mongoose.Schema(
  {
    ...
    assignedFromPartner: { type: mongoose.Schema.Types.ObjectId, ref: 'Partner' },
    pickupDistanceKm: { type: Number },
    assignedAmbulances: [{
      driverId: { type: mongoose.Schema.Types.ObjectId, ref: "IndividualDriver" },
      assignedAt: { type: Date, default: Date.now },
      plateNumber: String,
      status: { type: String, enum: ['assigned', 'en route', 'arrived', 'cancelled'], default: 'assigned' },
    }
    ],
  },
  { timestamps: true }
